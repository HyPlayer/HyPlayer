...
public partial class Setting : INotifyPropertyChanged
{
    ...
    /// </summary>
    public HyPlayerUISettings UI { get; } = new();
    ...
    /// </summary>
    public LyricSettings Lyric { get; } = new();

    /// <summary>
    ///     Last.FM integration settings.
    /// </summary>
    public LastFMSettings LastFM { get; } = new();
    ...
    {
        get => Playback.audioRate;
        set
        {
            Playback.audioRate = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Playback.CrossFadeTime;
        set
        {
            Playback.CrossFadeTime = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Playback.EnableAudioGain;
        set
        {
            Playback.EnableAudioGain = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Playback.enableCache;
        set
        {
            Playback.enableCache = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Playback.cacheDir;
        set
        {
            Playback.cacheDir = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Playback.AudioRenderDevice;
        set
        {
            Playback.AudioRenderDevice = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Playback.EnableFFT;
        set
        {
            Playback.EnableFFT = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Playback.ActiveStrategyId;
        set
        {
            Playback.ActiveStrategyId = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.expandAnimation;
        set
        {
            UI.expandAnimation = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.lyricAlignment;
        set
        {
            UI.lyricAlignment = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.ColorGeneratorType;
        set
        {
            UI.ColorGeneratorType = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.expandedPlayerBackgroundType;
        set
        {
            UI.expandedPlayerBackgroundType = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.albumBorderLength;
        set
        {
            UI.albumBorderLength = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.expandedUseAcrylic;
        set
        {
            UI.expandedUseAcrylic = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.expandAlbumBreath;
        set
        {
            UI.expandAlbumBreath = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.expandedPlayerFullCover;
        set
        {
            UI.expandedPlayerFullCover = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.expandedCoverShadowDepth;
        set
        {
            UI.expandedCoverShadowDepth = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.CompactPlayerPageBlurStatus;
        set
        {
            UI.CompactPlayerPageBlurStatus = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.AutoHidePlaybar;
        set
        {
            UI.AutoHidePlaybar = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.AutoHidePlaybarTime;
        set
        {
            UI.AutoHidePlaybarTime = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.playBarMargin;
        set
        {
            UI.playBarMargin = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.displayShuffledList;
        set
        {
            UI.displayShuffledList = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.displayMaintain;
        set
        {
            UI.displayMaintain = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.enableTouchGestureAction;
        set
        {
            UI.enableTouchGestureAction = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.animationAdaptBPM;
        set
        {
            UI.animationAdaptBPM = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.gentleBPMAnimation;
        set
        {
            UI.gentleBPMAnimation = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.canaryChannelAvailability;
        set
        {
            UI.canaryChannelAvailability = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.localProgressiveLoad;
        set
        {
            UI.localProgressiveLoad = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => UI.EnableTileBackground;
        set
        {
            UI.EnableTileBackground = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Api.ApiAdditionalParametersJson;
        set
        {
            Api.ApiAdditionalParametersJson = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Api.EnableCheckTokenApi;
        set
        {
            Api.EnableCheckTokenApi = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Api.enableApiCache;
        set
        {
            Api.enableApiCache = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Api.songUrlLazyGet;
        set
        {
            Api.songUrlLazyGet = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Api.greedlyLoadPlayContainerItems;
        set
        {
            Api.greedlyLoadPlayContainerItems = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Api.AutoAddGreedilyLoadedSongsToPlayList;
        set
        {
            Api.AutoAddGreedilyLoadedSongsToPlayList = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Api.jumpVipSongPlaying;
        set
        {
            Api.jumpVipSongPlaying = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Api.jumpVipSongDownloading;
        set
        {
            Api.jumpVipSongDownloading = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.LyricRomajiSource;
        set
        {
            Lyric.LyricRomajiSource = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.showComposerInLyric;
        set
        {
            Lyric.showComposerInLyric = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.downloadLyric;
        set
        {
            Lyric.downloadLyric = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.downloadTranslation;
        set
        {
            Lyric.downloadTranslation = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.MigrateLyrics;
        set
        {
            Lyric.MigrateLyrics = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.OptimizeLyric;
        set
        {
            Lyric.OptimizeLyric = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricDropshadow;
        set
        {
            Lyric.lyricDropshadow = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricCacheRenderTarget;
        set
        {
            Lyric.lyricCacheRenderTarget = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricScaleSize;
        set
        {
            Lyric.lyricScaleSize = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricLineSpacing;
        set
        {
            Lyric.lyricLineSpacing = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.translationSize;
        set
        {
            Lyric.translationSize = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.romajiSize;
        set
        {
            Lyric.romajiSize = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricPaddingTopRatio;
        set
        {
            Lyric.lyricPaddingTopRatio = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricFadingRatio;
        set
        {
            Lyric.lyricFadingRatio = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.hotlyricOnStartup;
        set
        {
            Lyric.hotlyricOnStartup = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.enableAmllTtmlDb;
        set
        {
            Lyric.enableAmllTtmlDb = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.amllTtmlMirrorUrl;
        set
        {
            Lyric.amllTtmlMirrorUrl = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricRenderFocusHighlighting;
        set
        {
            Lyric.lyricRenderFocusHighlighting = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricRenderWidthRatio;
        set
        {
            Lyric.lyricRenderWidthRatio = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricRenderTransliterationScanning;
        set
        {
            Lyric.lyricRenderTransliterationScanning = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricRenderSimpleLineScanning;
        set
        {
            Lyric.lyricRenderSimpleLineScanning = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricRenderScanStyle;
        set
        {
            Lyric.lyricRenderScanStyle = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricRenderScaleWhenFocusing;
        set
        {
            Lyric.lyricRenderScaleWhenFocusing = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricRenderTransform3D;
        set
        {
            Lyric.lyricRenderTransform3D = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricRenderBlur;
        set
        {
            Lyric.lyricRenderBlur = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.lyricRenderFade;
        set
        {
            Lyric.lyricRenderFade = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.LineRollingCalculator;
        set
        {
            Lyric.LineRollingCalculator = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.LyricRendererDebugMode;
        set
        {
            Lyric.LyricRendererDebugMode = value;
            OnPropertyChanged();
        }
    }
#nullable enable
    ...
    {
        get => Lyric.pureLyricIdleColor;
        set
        {
            Lyric.pureLyricIdleColor = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.pureLyricFocusingColor;
        set
        {
            Lyric.pureLyricFocusingColor = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.karaokLyricFocusingColor;
        set
        {
            Lyric.karaokLyricFocusingColor = value;
            OnPropertyChanged();
        }
    }
#nullable restore
    ...
    {
        get => Lyric.IsolationFullThrottle;
        set
        {
            Lyric.IsolationFullThrottle = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.IsolationFPS;
        set
        {
            Lyric.IsolationFPS = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.IsolationScale;
        set
        {
            Lyric.IsolationScale = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => Lyric.IsolationLightWave;
        set
        {
            Lyric.IsolationLightWave = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => LastFM.LastFMSession;
        set
        {
            LastFM.LastFMSession = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => LastFM.UpdateLastFMNowPlaying;
        set
        {
            LastFM.UpdateLastFMNowPlaying = value;
            OnPropertyChanged();
        }
    }
    ...
    {
        get => LastFM.LastFMScrobble;
        set
        {
            LastFM.LastFMScrobble = value;
            OnPropertyChanged();
        }
    }
    ...
    public OccupySolution downloadNameOccupySolution
    {
        ...
        set
        {
            ApplicationData.Current.LocalSettings.Values[nameof(downloadNameOccupySolution)] = (int)value;
            OnPropertyChanged();
        }
    }
    ...
    {
        var container =
            ApplicationData.Current.LocalSettings.CreateContainer("LoginedUser",
                ApplicationDataCreateDisposition.Always);
        container.Values.Clear();
        foreach (var item in sessionValues) container.Values[item.Key] = item.Value;
        return true;
    }
    ...
    public static IReadOnlyDictionary<string, string> LoadCookies()
    {
        ...
        {
            if (container.Values.Count == 0) return new Dictionary<string, string>();
