...
public sealed class ChopinAudioServiceAdapter :
    AudioServiceBase,
    ...
    IAudioTicketListProvidable
{
    ...
    public ChopinAudioServiceAdapter(IPlayer player)
    {
        _player = player;
    }

    public override string Id => "hyplayer.chopin.adapter";

    public override string Name => "HyPlayer Chopin AudioService Adapter";
