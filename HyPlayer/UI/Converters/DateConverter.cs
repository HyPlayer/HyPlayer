...
public partial class DateConverter : IValueConverter
{
    ...
    {
        if (value is long || value is int) return FriendFormat(GetDateTimeFromTimeStamp((long)value));

        if (value is DateTime time) return FriendFormat(time);
